...
-- Add 
    ...
    'Add/esx_basicneeds/config.lua',
	'Add/esx_basicneeds/client/main.lua',
...
-- Utils
    ...
    "Modules/Utils/goFast/server/*.lua",
	"Modules/Utils/Shop/server/*.lua",
...
-- Administration 
    ...
    'Add/esx_basicneeds/config.lua',
	'Add/esx_basicneeds/server/main.lua',
