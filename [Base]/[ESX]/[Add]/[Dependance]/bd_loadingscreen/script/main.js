...
var texts = ["CONNEXION AU SERVEUR", "PRÉPARATION DES RESSOURCES", "ÉTABLISSEMENT DE LA CONNEXION"];
var currentText = 0;
...
(function welcometext() {
    var welcomes = ['Commencez votre nouvelle aventure passionnante.', 'Découvrez les merveilles de votre nouvelle ville.', 'Ouvrez la porte à un tout nouveau chapitre.', 'Entrez dans un monde de nouvelles possibilités.', 'Embrassez votre nouveau départ.'];
